...
This is the first verion of the library management tool. There are multiple updates that can be completed quite easily to ensure more usability and performance. One of these updates can include better handling of duplicates and the ability to add a location where books can be found in the library, or logic for the implementation of a Dewey Decimal Classification within the library.  
...
Ku6iK_Ru6IKa. (2020) color-terminal 1.0 [Available at] https://pypi.org/project/color-terminal/

Pip Creators. (2024) Download latest version of pip [Available at] https://pypi.org/project/pip/

Python Creators. (2024) Download the latest verion of Python [Available at] https://www.python.org/downloads/

sadrasabouri. s,haghighi. (2024) ASCII Art Library for Python art 6.2 [Available at] https://pypi.org/project/art/

van Rossum, G. Warsaw, B. Coghlan, A. (2013) PEP 8 - Style Guide for Python Guide [Available at] https://pypi.org/project/pip/